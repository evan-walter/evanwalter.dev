...
export default function TextGenerator() {
  ...
  const [tempPrompt, setTempPrompt] = useState(
    'Tell me why Evan is a fantastic software engineer. Touch on his teachability, curiosity, value for communication, and care for his team contribution.'
  )
      ...
      {data.length > 0 && !loading ? (
        <div>
          ...
          <p className='mt-16 text-sm opacity-75'>
            Note: The responses above are not my own and are generated by
            ChatGPT 😆.
          </p>
        </div>
      ) : null}
